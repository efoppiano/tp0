...
def initialize_config():
    ...
    try:
        ...
        config_params["udp_broadcast_ip"] = os.getenv('UDP_BROADCAST_IP', config["DEFAULT"]["UDP_BROADCAST_IP"])
        config_params["udp_broadcast_port"] = int(os.getenv('UDP_BROADCAST_PORT', config["DEFAULT"]["UDP_BROADCAST_PORT"]))
